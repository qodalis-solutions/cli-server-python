...
# The parent package name contains a hyphen, so we use importlib for the
# sibling ``plugins.filesystem`` package which *is* a valid identifier.
_fs = importlib.import_module("plugins.filesystem")
